...
namespace GrKouk.WebRazor.Pages.Expenses
{
    public class IndexModel : PageModel
    {
        ...
        public async Task OnGetAsync(string sortOrder, string searchString, int? pageIndex)
        {
           ...
           // FinDiaryTransaction = Mapper.Map<PaginatedList<FinDiaryExpenseTransactionDto>>(fCtx);
            //FinDiaryTransaction = Mapper.Map<List<FinDiaryExpenseTransactionDto>>((List<>fCtx);
        }
    }
}
