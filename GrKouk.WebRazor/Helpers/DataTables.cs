...
namespace GrKouk.WebRazor.Helpers
{
    ...
    public class DataTableParameters
    {
        ...
        public IEnumerable<Dictionary<string, string>> Columns { get; set; }
        //public DataTableColumn[] Columns { get; set; }
        public IEnumerable<Dictionary<string, string>> Order { get; set; }
    ...
    public class MyDataTablesResponse 
    {
        /// <summary>
        ...
        protected MyDataTablesResponse(int draw, string errorMessage)
        ...
        /// <param name="draw">Draw count from request object.</param>
        /// <param name="errorMessage">Error message.</param>
        protected MyDataTablesResponse(int draw, string errorMessage, IDictionary<string, object> additionalParameters)
        {
            Draw = draw;
            Error = errorMessage;
        ...
        protected MyDataTablesResponse(int draw, int totalRecords, int totalRecordsFiltered, object data)
        ...
        /// <param name="data">Data object (collection).</param>
        protected MyDataTablesResponse(int draw, int totalRecords, int totalRecordsFiltered, object data, IDictionary<string, object> additionalParameters)
        {
            Draw = draw;
        ...
        public static MyDataTablesResponse Create(int draw, int totalRecords, int totalRecordsFiltered, object data)
        {
            return MyDataTablesResponse.Create(draw, totalRecords, totalRecordsFiltered, data, null);
        }
        /// <summary>
        /// Creates a new response instance.
        /// </summary>
        ...
        /// <param name="additionalParameters">Aditional parameters for response.</param>
        /// <returns>The response object.</returns>
        public static MyDataTablesResponse Create(int draw, int totalRecords, int totalRecordsFiltered, object data, IDictionary<string, object> additionalParameters)
        {
            ...
            return new MyDataTablesResponse(draw, totalRecords, totalRecordsFiltered, data, additionalParameters);
        }
        /// <summary>
        /// Creates a new response instance.
        /// </summary>
        ...
        /// <param name="errorMessage">Error message.</param>
        /// <returns>The response object.</returns>
        public static MyDataTablesResponse Create(int draw, string errorMessage)
        {
            return MyDataTablesResponse.Create(draw, errorMessage, null);
        }
        /// <summary>
        /// Creates a new response instance.
        /// </summary>
        ...
        /// <param name="errorMessage">Error message.</param>
        /// <returns>The response object.</returns>
        public static MyDataTablesResponse Create(int draw, string errorMessage, IDictionary<string, object> additionalParameters)
        {
            ...
            return new MyDataTablesResponse(draw, errorMessage, additionalParameters);
        }
    }
}
