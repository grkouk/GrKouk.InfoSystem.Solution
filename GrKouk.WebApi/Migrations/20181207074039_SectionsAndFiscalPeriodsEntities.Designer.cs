...
namespace GrKouk.WebApi.Migrations
{
    ...
    [Migration("20181207074039_SectionsAndFiscalPeriodsEntities")]
    partial class SectionsAndFiscalPeriodsEntities
    {
            ...
            modelBuilder.Entity("GrKouk.InfoSystem.Domain.Shared.BuyMaterialsDocument", b =>
                {
                    ...
                    b.HasOne("GrKouk.InfoSystem.Domain.FinConfig.BuyDocSeriesDef", "DocSeries")
                        .WithMany()
                        .HasForeignKey("DocSeriesId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("GrKouk.InfoSystem.Domain.FinConfig.BuyDocTypeDef", "DocType")
                        .WithMany()
