...
{
	public class CompaniesSearchListPageViewModel : ViewModelBase
    {
	    private readonly IAutoCompleteDataSource<Company> _itemAutoCompleteDs;
        public CompaniesSearchListPageViewModel(INavigationService navigationService
            , IAutoCompleteDataSource<Company> itemAutoCompleteDs
