...
{
	public class CostCentresSearchListPageViewModel : ViewModelBase
    {
        private readonly IAutoCompleteDataSource<CostCentre> _itemAutoCompleteDs;
        public CostCentresSearchListPageViewModel(INavigationService navigationService
            , IAutoCompleteDataSource<CostCentre> itemAutoCompleteDs
        ) : base(navigationService)
        {
            _itemAutoCompleteDs = itemAutoCompleteDs;
            Title = "Επιλογή Κ.Κόστους";
        }
        ...
        private async void ItemTappedCmd(SearchListItem itemTapped)
        {
            ...
            p.Add("CοstCentreSelected", itemTapped);
